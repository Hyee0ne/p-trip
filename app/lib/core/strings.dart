...
class S {
  ...
  /// ⚠ 근거는 연관 관광지(같은 방문자가 함께 찾은 곳) 순위의 **두 시점 비교**다 (2026-09-16 개정 2차).
  ///   '늘었다'는 증가량을 아는 말이고 순위 상승은 증가가 아니다 — 문구는 **최근 기준**이라는 것만 말한다.
  ///   두 시점이 있는 노선과 한 시점뿐인 노선은 근거가 달라 문구를 나눈다 (원칙 3).
  static const routeNoteRising = '최근에도 함께 찾는 곳이 많아요';
