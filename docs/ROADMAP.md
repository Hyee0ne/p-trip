...
- [ ] CO-01 홈: 카피 헤더, 국도 레일, 코스 카드, **급상승 실데이터 섹션**, "오늘만 열리는 발견"
- [ ] CO-07 국도 선택: 51선 그리드, 남북/동서 탭, drivable 구분("통일을 기다리는 길")
- [ ] CO-02 코스 상세: 지도 폴리라인+핀, 거점 배너 3종, 발견 리스트, 출발 CTA
- [ ] CO-03 스팟 상세: 사진/영업/확신도 문구/전화 원탭/spot_links/외부 링크
