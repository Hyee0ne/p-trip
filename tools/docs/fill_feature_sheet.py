...
FLOWS = [
    {
        'title': '길 선택 · 방향 결정 · 출발',
        'desc': ['목적지가 아닌 길을 선택. 홈 지도에 국도 51선 전체 표시',
                 '방향만 정하면 출발. 길안내는 티맵·애플 지도로 연결'],
        ...
        'steps': [
            ...
            ['④ 길안내 핸드오프', '- 티맵 / 애플 지도로 연결', '- 앱 자체 턴바이턴·ETA 없음'],
        ],
    },
    {
        'title': '발견 레이더 · 전면 카드',
        'desc': ['현재 위치·진행 방향 반경 5km에서 영업정보·사진이 확인된 스팟만 카드 한 장으로',
                 '장날·일몰·마감 임박 우선. 넘기기 / 들르기 / 찜'],
        ...
        'steps': [
            ...
            ['④ 들르기', '- 티맵 목적지 변경', '- 「오늘 들른 곳」 자취에 사진으로 기록'],
        ],
    },
    {
    ...
    {
        'title': '소리 · 알림 · 설정',
        'desc': ['주행 중 화면 대신 소리로 우선 안내, 놓친 발견은 알림에 보관',
                 '위치 권한은 출발 시, 알림 권한은 첫 주행 후 요청'],
        'shots': ['onboard3-t6.png', '3_card.png', 'myset2-t8.png', '5_spot.png'],
        'steps': [
            ['① 온보딩', '- 「앞쪽에 뭐가 있는지, 카드 한 장으로」', '- 소리·알림 안내'],
            ['② 음성 낭독', '- 카드 문장을 그대로 읽음', '- 내비 음성을 끊지 않고 잠시 낮춤'],
            ['③ 설정', '- 「앱을 꺼둬도 알림」(백그라운드 위치 옵트인)', '- 「발견 간격」 자주·보통·가끔 · 데이터 출처'],
            ['④ 알림 → 상세', '- 알림 선택 시', '- 해당 발견의 상세 화면으로 이동'],
        ],
    },
]
