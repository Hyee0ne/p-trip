...
INTRO = {
    ...
    'why': [
        '• 즉흥 여행의 확산',
        '- 「풍향중」처럼 목적지 없이 떠나는 여행이 유행. 국도에서 우연히 만나는 새로움에 대한 수요 증가',
        '• 즉흥 여행의 리스크',
        ...
        '• 기획 방향',
        '- 목적지는 묻지 않되 우연을 데이터로 뒷받침하는 앱',
        '- 국도에서 만난 우연이 하루의 여행기로 남고, 발길이 소도시·시장·자연으로 분산',
    ],
}

FEATURES_LIST = [
    '1. 길 선택과 출발',
    '- Apple 지도 위에 국도 51선 전체 표시. 내 주변에서 탈 수 있는 길과 노선별 큐레이션 한 줄',
    '- 목적지·도착 시각 없이 방향(북/남, 동/서)만 선택 → 티맵·애플 지도로 길안내 연결 (앱은 내비게이션이 아님)',
    '2. 발견 레이더',
    '- 현재 위치·진행 방향 반경 5km에서 영업정보·사진이 확인된 스팟만 전면 카드 한 장으로 제시',
    '- 별점·후기 없이 데이터 완성도로 신뢰 확보. 장날·일몰·마감 임박 우선. 넘기기 / 들르기 / 찜',
    '3. 소리와 알림',
    '- 내비 실행 중에도 음성 우선 안내 (내비 음성을 끊지 않고 일시적으로 낮춤)',
    '- 놓친 발견은 알림에 보관, 선택 시 상세 화면으로 이동',
    '4. 들른 뒤 이어가기',
    '- 정차 2분 시 「여기서 앞쪽으로」 앞쪽 10km 후보 3곳 제시',
    '- 주행 중 다른 국도로 갈아타도 여행과 기록 유지',
    '5. 여행기',
    '- 하루를 「N번 국도에서 생긴 일」 한 편으로 자동 기록',
    '- 지나온 길 포스터 · 들른 곳 타임라인 · 공유 카드(시작·끝 300m 자동 삭제) · 국도 51선 수집 현황',
]
