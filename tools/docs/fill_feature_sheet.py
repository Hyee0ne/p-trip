...
FEATURES_LIST = [
    ...
    '4. 소리·알림과 내비 연결 — 내비를 켠 채로도 놓치지 않고, 마음에 들면 바로 안내합니다',
    ...
    '',
    '• 추천 기준 · 이용 안내',
    '- 사진과 소개·영업정보를 갖춘 장소만 추천합니다. 표시 거리는 직선거리이며, 장날·휴무일은 안내하되 임시휴무는 방문 전 확인이 필요합니다. 장소 선택은 동승자 또는 정차한 운전자가 진행합니다.',
]
...
FLOWS = [
    ...
    },
    {
        ...
        'steps': [
            ...
            ['③ 잠금화면 알림', '- 「오늘이 마침 경안시장이에요」 (2026-09-13 실주행)', '- 음성 낭독은 데모 영상 「덕풍공원」 카드 구간'],
    ...
    },
    {
        ...
        'steps': [
            ...
            ['③ 장소 상세', '- 사진 · 소개 · 영업정보 · 장날', '- 별점 없이 「네이버 후기 보기」 링크만'],
...
TOUR_APIS = [
    ...
    ('국문 관광정보 — 공통정보 조회 detailCommon2 · 소개정보 조회 detailIntro2',
     ['개요·영업시간·휴무일·장날·전화번호 → 추천 기준(사진 + 소개·영업정보) 판정과 카드 본문',
...
OTHER_DATA = [
    ('한국천문연구원 출몰시각 정보 OpenAPI (RiseSetInfoService)',
     ['전망 스팟이 있는 0.1° 격자 × 30일의 일몰 시각 캐시 → 일몰 40분 전 뷰포인트 카드·알림',
      '(예: 「곧 추암 촛대바위에 해가 져요」)']),
